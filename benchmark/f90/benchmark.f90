program benchmark
    ...
    ! File path (must be modified on Leonardo to correspond to where the data is)
    !------------
    ! character (len=100), parameter:: FILE_NAME ="/home/aredjil/projects/OASIM_ATM/data000.nc"
